...
public final class ExtentReport {
	...
	private static String reportFileName = "DrAppAutomationReport.html";
	...
	public static void initReports() {
		if(Objects.isNull(extent)) {
			...
			spark.config().setDocumentTitle("Dr App Automation Report.");
			spark.config().setReportName("Dr App Automation Report.");
		}
	}
