...
public class SetUpVirtualConsultTiming extends BasePage {
	...
	public SetUpVirtualConsultTiming() {
		initProp() ;
	...
	public void SetUpVirtualConsultingTimings() throws InterruptedException
	{
		...
		testUtil.doClick(Timing,"Set Up");
		...
		testUtil.doClick(Time,"Time for the days");
		Thread.sleep(2000);
    	...
    	ExtentLogger.pass( "AM PM Timing set" + " Clicked ");
    	
       testUtil.doClick(OK,"Save");
       testUtil.dosendKeys(SlotLength, 10, "30","Slot Legth");
       testUtil.doClick(NextButton,"Next utton");
